...
<head>
    ...
    <title>Ringkasan Aktiviti Latihan Industri-minggu 20</title>
...
<body>
    ...
    <section class="projects" id="projects">
        <div class="home-content">
            <h1 class="">MINGGU 20</h1>

            <div class="date-header">
                <h2 class="heading">18 May 2026 - 22 May 2026</h2>
            </div>
           ...
           <div class="projects-box">
                ...
                <div class="project-card">
                    <img src="/img/minggu/minggu20/image.png" alt="" class="">
                    <h3>1. Membuat Template Sistem</h3>
                    <p>- Membuat template sistem siap pakai untuk projek yang akan datang didalam
                        framework Yii2 Advance dan Laravel 12.<br>
                    </p><br>
                    <h3>Impak yang diterima</h3>
                    <p>- Menciptakan template yang mudah difahami dengan menerapkan feature-feature seperti:<br>
                        1. Role Based Access Control(RBAC).<br>
                        2. Simple Create, Read, Update dan Delete(CRUD).<br>
                        3. Authentication dan Middleware.<br>
                        4. Artificial Intelligence(Ai) assistence generator.<br>
                    </p>
                ...
                <div class="project-card">
                    ...
                    <p>- Menambah modul untuk device baru iaitu Nkji Air-tag didalam
                        website beambox yang kami dirikan.<br>
                        - Mendirikan dengan menggunakan software Joomla CMS.<br>
                    </p><br>
                    <h3>Impak yang diterima</h3>
                    <p>- Mempelajari lebih mendalam tentang selok-belok
                        Joomla CMS.<br>
                        - Mengasah lagi ilmu sedia ada bagi kegunaan masa hadapan.<br>
                    </p>
                </div>
