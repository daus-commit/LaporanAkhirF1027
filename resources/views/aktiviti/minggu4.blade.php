...
<head>
    ...
    <title>Ringkasan Aktiviti Latihan Industri-minggu 4</title>
...
<body>
    ...
    <section class="projects" id="projects">
        <div class="home-content">
            <h1 class="">MINGGU 4</h1>

            <div class="date-header">
                <h2 class="heading">26 Jan 2026 - 30 Jan 2026</h2>
            </div>
            ...
            <div class="projects-box">
                ...
                <div class="project-card">
                    <img src="/img/minggu/minggu3/image.png" alt="" class="">
                    <h3>1. Sambung membangunkan Project Dummy website untuk app USIMMasjidpro dalam bentuk website</h3>
                    <p>- Membangunkan dengan menggunakan laravel 12.
                    </p>
                </div>

                <div class="project-card">
                    <img src="/img/minggu/minggu4/image2.jpeg" alt="" class="">
                    <h3>2. Membuat design UI(UserInterface) bagi TadikaPro app version 3.0</h3>
                    <p>- Membuat design ui dengan mengguanakan figma.<br>
                        - Mencari design rujukan di website Dribble.
                    </p><br>
                    <h3>Impak yang diterima(Cabaran)</h3>
                    <p>- Tidak pernah membuat design UI didalam figma kerana kebanyakkan project
                        termasuk FYP saya lebih banyak kearah bahagian backend.
                    </p><br>
                    <h3>Cara penyelesaian</h3>
                    <p>- Membaca documentation Figma.<br>
                        - Meminta bantuan AI dan youtube.
                    </p><br>
                    <h3>Impak yang diterima(Kemahiran)</h3>
                    <p>- Mengetahui jalan kerja UI/UX developer.<br>
                        - Mendapat ilmu baru.
                    </p>
                </div>
