...
<head>
    ...
    <title>Ringkasan Aktiviti Latihan Industri-minggu 6</title>
...
<body>
    ...
    <section class="projects" id="projects">
        <div class="home-content">
            <h1 class="">MINGGU 6</h1>

            <div class="date-header">
                <h2 class="heading">9 Feb 2026 - 13 Feb 2026</h2>
            </div>
            ...
            <div class="projects-box">
                ...
                <div class="project-card">
                    <img src="/img/minggu/minggu6/image.jpeg" alt="" class="">
                    <h3>1. Membuat manual pengguna untuk TadikaPro app version 3.0</h3>
                    <p>- Membuat manual dengan didalam google docs dengan merujuk manual TadikaPro version 2.0.
                    </p><br>
                    <h3>Impak yang diterima(Cabaran)</h3>
                    <p>- Kali pertama menggunakan feature advance di google docs
                    </p><br>
                    <h3>Cara penyelesaian</h3>
                    <p>- Belajar mandiri.<br>
                        - Mendapat ilmu baru.
                    </p><br>
                    <h3>Impak yang diterima(Kemahiran)</h3>
                    <p>- Belajar menjadi seseorang yang professional dalam apa jua situasi.<br>
                    </p>
                    <img src="/img/minggu/minggu6/image3.jpeg" alt="" class="">
                </div>

                <div class="project-card">
                    <img src="/img/minggu/minggu6/image2.jpeg" alt="" class="">
                    <h3>2. Menghadiri pelancaran USIMMasjidPro App di menara Affin(TRX)</h3>
                    <p>- Membantu dalam menyediakan bahan pembentangan untuk tujuan pelancaran.
                    </p><br>
                    <h3>Impak yang diterima(Kemahiran)</h3>
                    <p>- Belajar untuk sentiasa professional dalam apa jua keadaan.<br>
                        - Belajar mengendalikan masjis yang didatangi orang-orang yang agak terhormat.
                    </p>
                </div>
