...
<head>
    ...
    <title>Ringkasan Aktiviti Latihan Industri-minggu 2</title>
...
<body>
    ...
    <section class="projects" id="projects">
        <div class="home-content">
            <h1 class="">MINGGU 2</h1>

            <div class="date-header">
                <h2 class="heading">12 Jan 2026 - 16 Jan 2026</h2>
            </div>
            ...
            <div class="projects-box">
                ...
                <div class="project-card">
                    <img src="/img/minggu/minggu2/image5.jpeg" alt="" class="">
                    <h3>1. Outstation ke luar kawasan office(Perak)</h3>
                    <p>- Membantu para jemaah masjid sekitar Perak(Taiping, Kuala Kangsar dan Gerik) dalam menggunakan app
                        USIMMasjidPro secara lebih baik.<br>
                        - Membantu mengambil kehadiran para jemaah masjid.<br>
                        - Membantu menyediakan keperluan sebelum sesi pembentangan.
                    </p>
                </div>

                <div class="project-card">
                    <h3>Impak yang diterima</h3>
                    <p>- Belajar untuk bersosial dengan masyarakat tempatan.<br>
                        - Belajar untuk mengurus masa dengan lebih baik.<br>
                        - Belajar untuk mengurus sesuatu program disertai dengan plan resiko.
                    </p>
                </div>

                <div class="project-card">
                    <img src="/img/minggu/minggu2/image4.jpeg" alt="" class="">
                    <p>Gambar ketika di Masjid Al-Islah, Taiping
                    </p>
                </div>

                <div class="project-card">
                    <img src="/img/minggu/minggu2/image3.jpeg" alt="" class="">
                    <p>Gambar ketika di Masjid Ridzwaniah, Kuala Kangsar
                    </p>
                </div>

                <div class="project-card">
                    <img src="/img/minggu/minggu2/image2.jpeg" alt="" class="">
                    <p>Gambar ketika di Masjid Nurussalam, Gerik
                    </p>
                </div>
            </div>
