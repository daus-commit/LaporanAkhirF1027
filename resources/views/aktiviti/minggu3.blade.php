...
<head>
    ...
    <title>Ringkasan Aktiviti Latihan Industri-minggu 3</title>
...
<body>
    ...
    <section class="projects" id="projects">
        <div class="home-content">
            <h1 class="">MINGGU 3</h1>

            <div class="date-header">
                <h2 class="heading">19 Jan 2026 - 23 Jan 2026</h2>
            </div>
            ...
            <div class="projects-box">
                ...
                <div class="project-card">
                    ...
                    <h3>1. Membangunkan Project Dummy website untuk app USIMMasjidpro dalam bentuk website</h3>
                ...
                <div class="project-card">
                    ...
                    <p>- Database didalam phpmyadmin tidak dapat membaca data yang dimasukkan oleh pengguna.<br>
                        <br>
                    </p>

                    <h3>Cara penyelesaian</h3>
                    <p>- Membaca public forum dan documentation laravel 12.<br>
                        - Meminta bantuan AI dan youtube.<br>
                    </p>
                </div>

                <div class="project-card">
                    <h3>Impak yang diterima(Kemahiran)</h3>
                    <p>- Belajar untuk mandiri tanpa menyusahkan orang sekitar.<br>
                        - Mengetahui bahagian mana yang bermasaalah.<br>
                    </p>
                </div>

                <div class="project-card">
                    <img src="/img/minggu/minggu3/image2.jpeg" alt="" class="">
                    <h3></h3>
                    <p>
                    </p>
                </div>
