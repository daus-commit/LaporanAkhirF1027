...
<head>
    ...
    <title>Ringkasan Aktiviti Latihan Industri-minggu 15</title>
...
<body>
    ...
    <section class="projects" id="projects">
        <div class="home-content">
            <h1 class="">MINGGU 15</h1>

            <div class="date-header">
                <h2 class="heading">13 April 2026 - 17 April 2026</h2>
            </div>
           ...
           <div class="projects-box">
                ...
                <div class="project-card">
                    ...
                    <h3>1. Mencari error/bug didalam sistem TadikaPro v3.</h3>
                    <p>- Melaporkan error/bug yang ada didalam sistem TadikaPro dan
