...
<head>
    ...
    <title>Ringkasan Aktiviti Latihan Industri-minggu 9</title>
...
<body>
    ...
    <section class="projects" id="projects">
        <div class="home-content">
            <h1 class="">MINGGU 9</h1>

            <div class="date-header">
                <h2 class="heading">2 March 2026 - 6 March 2026</h2>
            </div>
           ...
           <div class="projects-box">
                ...
                <div class="project-card">
                    ...
                    <h3>1. Mencari error/bug didalam sistem TadikaPro v.3.0.</h3>
                    <p>- Melaporkan error/bug yang ada didalam sistem TadikaPro v3.0 dan
                        melaporkannya ke dalam google docs.
                    </p><br>
                    ...
                    <p>- Belajar untuk menjadi seorang software testing/QA.<br>
                        ...
                        modul, button dan function yang ada dapat digunakan dengan baik.
                    </p>
                </div>

                <div class="project-card">
                    <img src="/img/minggu/minggu7/image2.jpeg" alt="" class="">
                    <h3>2. Membuat video content di Tiktok bagi App TadikaPro</h3>
                    <p>- Menggunakan Canva sebagai tool software untuk membuat content.<br>
                        - Generate img content dengan menggunakan AI(ChatGPT).
                    </p>
                </div>
