...
<head>
    ...
    <title>Ringkasan Aktiviti Latihan Industri-minggu 8</title>
...
<body>
    ...
    <section class="projects" id="projects">
        <div class="home-content">
            <h1 class="">MINGGU 8</h1>

            <div class="date-header">
                <h2 class="heading">23 Feb 2026 - 27 Feb 2026</h2>
            </div>
           ...
           <div class="projects-box">
                ...
                <div class="project-card">
                    <img src="/img/minggu/minggu8/image.png" alt="" class="">
                    <h3>1. Mengemaskini resume setiap staff yang terlibat dengan projek PLKN.</h3>
                    <p>- Mengemaskini resume staff ke dalam file google docs yang disediakan.
                    </p>
                </div>

                <div class="project-card">
                    <h3>Impak yang diterima(Cabaran)</h3>
                    <p>- Belajar untuk bekerja dibawah tekanan kerana
                        due date yang mendekat.
                    </p>

                    <h3>Cara penyelesaian</h3>
                    <p>- Tetap tenang dan kekal profesional dalam
                        apa jua keadaan.
                    </p>
                </div>

                <div class="project-card">
                    <img src="/img/minggu/minggu8/image2.png" alt="" class="">
                    <h3>2. Mengemaskini gambar paparan skrin modul PLKN</h3>
                    <p>- Mengekses sistem PLKN untuk screenshot paparan setiap modul
                        yang ada.<br>
                        - Mengemaskini gambar screenshot tersebut ke dalam google docs Cadangan
                        Penyelesaian Teknikal Projek PLKN.
                    </p>
                </div>
