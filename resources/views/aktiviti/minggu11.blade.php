...
<head>
    ...
    <title>Ringkasan Aktiviti Latihan Industri-minggu 11</title>
...
<body>
    ...
    <section class="projects" id="projects">
        <div class="home-content">
            <h1 class="">MINGGU 11</h1>

            <div class="date-header">
                <h2 class="heading">16 March 2026 - 20 March 2026</h2>
            </div>
           ...
           <div class="projects-box">
                ...
                <div class="project-card">
                    <img src="/img/minggu/minggu11/image2.jpeg" alt="" class="">
                    <h3>1. Mendirikan landing website CMS untuk Beambox Malaysia.</h3>
                    <p>- Mendirikan dengan menggunakan software Joomla CMS.<br>
                        - Memasukkan content daripada Beambox global kedalam website
                ...
                <div class="project-card">
                    <img src="/img/minggu/minggu11/image.png" alt="" class="">
                    <h3>2. Mula mendirikan website untuk Laporan Akhir LI sesi 2 2025/2026
                    </h3>
                    <p>- Mendirikan dengan menggunakan Framework Laravel 12 dengan menerapkan
                        konsep MVC.
                    </p><br>
                    <h3>Impak yang diterima</h3>
                    <p>- Belajar untuk mendirikan website yang mesra pengguna.<br>
                    </p>
                </div>
