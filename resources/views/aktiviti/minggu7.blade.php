...
<head>
    ...
    <title>Ringkasan Aktiviti Latihan Industri-minggu 7</title>
...
<body>
    ...
    <section class="projects" id="projects">
        <div class="home-content">
            <h1 class="">MINGGU 7</h1>

            <div class="date-header">
                <h2 class="heading">16 Feb 2026 - 20 Feb 2026</h2>
            </div>
           ...
           <div class="projects-box">
                ...
                <div class="project-card">
                    ...
                    <h3>2. Membuat Content untuk TadikaPro dan USIMMasjidPro App</h3>
